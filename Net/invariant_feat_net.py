...
class InvariantFeatureNet(nn.Module):
    ...
    """
    def __init__(self, in_channels=64, enc1_ch=64, enc2_ch=128, per_channel_sigma=True):
        super().__init__()
        self.feat_extract = XFeat(top_k=4096)
        ...
        self.encoder2 = SingleConvEncoder(enc1_ch, enc2_ch, kernel_size=1, padding=0, pool=True)
    ...
    def forward(self, x, grl_lambda=1.0):
        ...
        """
        # Get the xfeat feature 
        x = self.feat_extract.get_descriptors(x[None])[0]
